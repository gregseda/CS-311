...
{ 
  ...
  try{L2.addbeforeIth(9,12); } 
    ...
    {cerr << "Error has occured: Bad position was given" << endl; }
...
void caseThree()
{
  ...
  try {L3.deleteFront(x);}
    ...
    {cerr << "Error has occured: Front does not exist" << endl;}
}   //end of case 3
...
void caseFour()
{
  ...
  try {L4.deleteRear(x); }
    ...
    {cerr << "Error has occured: Rear does not exist" << endl;}
} // end of case 4


//PURPOSE of the Program: This is a linked list program that executes 4 different cases 
//Algorithm/Design: 4 test cases are divided into 3 functions and the program will execute the code that adjusts the linked list. Each case adds to the front and rear to the list and deletes them. The linked list destructor will be called after every case is executed. The user will enter 0 to exit the program
int main()
{
