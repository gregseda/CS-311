...
//PURPOSE of the program: to test the different functions in the implementation file
//ALGORITH/DESIGN: load multiple trees with elements and attempt different cases while inserting and deleting vertexes
int main()
{
  //***** test 1 **********************************************
